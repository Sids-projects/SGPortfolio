...
export class DataService {
  ...
  portfolioContent: any = [
    {
      title: { icon: 'fa-face-grin-wide', p: 'About' },
      img: './assets/bitmap.png',
      ul: {
        li1: 'Siddarth.G',
        li2: 'Portfolio',
        li3: 'Frontend Web Developer & Ui / Ux',
      },
      button: 'View all',
    },

    {
      title: { icon: 'fa-graduation-cap', p: 'Graduation' },
      ul: {
        li1: ['St.Peters University', 'B.com'],
        li2: ['Ecrrede', 'Web Development'],
      },
    },

    {
      title: { icon: 'fa-book', p: 'Course' },
      ul: {
        li1: ['Html, Css, Bootstrap'],
        li2: ['Javascript'],
        li3: ['Angular'],
        li4: ['ReactJs & React Native'],
      },
    },
  ];
  ...
  products: any = [
    {
      image: './../../../../assets/sole-journey/img/Shoe-1.png',
      brand: 'Swiftstride',
      prize: 180,
      type: 'Running Shoe',
      discount: 10,
    ...
    {
      image: './../../../../assets/sole-journey/img/Shoe-2.png',
      brand: 'Trailblazers',
      type: 'Hiking Boot',
      prize: 320,
      discount: 40,
    ...
    {
      image: './../../../../assets/sole-journey/img/Shoe-3.png',
      brand: 'Sojourn',
      type: 'Travel Sneaker',
      prize: 140,
      discount: 0,
  ...
  navTitles: any = [
    { title: 'Home', path: 'sj-home', navActive: false },
    { title: 'Shop', path: 'sj-shop', navActive: false },
    { title: 'Blog', path: 'sj-blog', navActive: false },
  ];
